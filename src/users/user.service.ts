...
export class UserService {
    ...
    static async generateToken(userId: string): Promise<any>  {
    ...
    static async createAndGetNewUser(newUser: IUser): Promise<any>  {
    ...
    static async getUserByPasswordAndEmail(password: string, email: string): Promise<any> {
        ...
        try {
            ...
            throw new ErrorHandler(404, 'The user does`t exist');
        }
    ...
    static async getUserByIdWithQuestions(userId: string): Promise<any>  {
    ...
    static async updatePersonalInfoAndGetUpdatedUser(updatedPersonalInfo: IPersonalInfo, userId: string): Promise<any>  {
