...
export class QuestionService {
	...
	static async closeQuestionAndGetBack(questionId: string) {
		await QuestionDataAccess.closeQuestion(questionId);

		return await QuestionService.getQuestionById(questionId);
	}

	static async createAndGetQuestion(newQuestion: IQuestion) {
	...
	static async getQuestionsByTag(hashtag: string) {
