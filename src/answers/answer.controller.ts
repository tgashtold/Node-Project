...
export class AnswerController {
    static async getAnswersFromRequestedPosition(req, res, next): Promise<any> {
        try {
    ...
    static async acceptAnswer(req, res, next): Promise<any> {
        try {
    ...
    static async getQuestionAndAnswers(req, res, next): Promise<any> {
        try {
            const questionId: string = req.params.questionId;
            const requestedAnswersNumber: number = +req.params.answersCount;
    ...
    static async addLikeAndUpdateQuestionAndAnswers(req, res, next): Promise<any> {
        try {
    ...
    static async createAndPostAnswer(req, res, next): Promise<any> {
        try {
