...
export class AnswerService {
    ...
    static async getQuestionAnswersCount(questionId: string): Promise<any> {
        return await AnswerDataAccess.findQuestionAnswersCount(questionId);
    }

    static async handleLikeAnswer(answerId: string, userId: string): Promise<any> {
    ...
    static async createAndGetNewAnswer(newAnswer: IAnswer): Promise<any> {
    ...
    static async acceptAnswerAndGetBack(answerId: string): Promise<any> {
